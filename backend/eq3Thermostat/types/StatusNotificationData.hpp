#ifndef THERMONATOR_EQ3THERMOSTAT_TYPES_STATUSNOTIFICATIONDATA_HPP
#define THERMONATOR_EQ3THERMOSTAT_TYPES_STATUSNOTIFICATIONDATA_HPP
...
public:
    StatusNotificationData() = default;
    ...
    static StatusNotificationData fromEncodedData(const QByteArray &data);
...
inline bool operator==(const StatusNotificationData &lhs,
                       const StatusNotificationData &rhs)
{
